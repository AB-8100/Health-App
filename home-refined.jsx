...
// ────────────────────────────────────────────────────────────
function RefinedHome({ width = 390, height = 820, theme = 'light', onNav, onStartSession, activeSession, onResumeSession, profile, completedSessions = [], onOpenAbout }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ flex:1, overflowY:'auto', padding:'4px 20px 14px', position:'relative' }}
        ...
        {(() => {
          const split = window.SPLITS && profile?.splitDays ? window.SPLITS[profile.splitDays] : null;
